                  ...
                  {[
                    ...
                    <div className="space-y-3 rounded-md border border-slate-200 p-3">
                      ...
                      <p className="text-xs text-muted-foreground">
                        ...
                        reserve capacity while you price or set the contact). A
                        held or accepted-but-unpaid booking can still be bumped
                        by the confirm-pending job if the lodge capacity for these
